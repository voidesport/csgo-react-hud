...
import { Crosshair, Skull } from "../../assets/Icons";
            ...
            <div className="row">
              ...
              <div className="stats">
                {player.state.round_kills ? 
                      <div className={`roundkill-container ${player.team.side}`}>
                        <div className="roundkill">
                          {player.state.round_kills}
                        </div>
                      </div> : null}
                <div className="kill_or_death">
                  <Crosshair/> {stats.kills}
                </div>
                <div className="kill_or_death">
                  <Skull/> {stats.deaths}
                </div>
